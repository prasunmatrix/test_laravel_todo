        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.post-settings') }}" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="mb-3">
                      <label>Address</label>
                      <input type="text" name="address" value="@if(!empty($settings->address)){{ $settings->address }} @endif"   class="form-control" />
                    ...
                    <div class="mb-3">
                      <label>Phone</label>
                      <input type="tel" name="phone"  value="@if(!empty($settings->phone)){{ $settings->phone }} @endif" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="12"   class="form-control" />
                      <span style="color:red;">{{ $errors->first('phone') }}</span>
                    </div>
                    <div class="mb-3">
                      <label>FAX Number</label>
                      <input type="tel" name="fax" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" value="@if(!empty($settings->fax)){{ $settings->fax }} @endif"  maxlength="12"  class="form-control" />
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="footer_title" value="@if(!empty($settings->footer_title)){{ $settings->footer_title }} @endif"   class="form-control" />
                      <span style="color:red;">{{ $errors->first('footer_title') }}</span>
                    </div>

                    <div class="mb-3">
                      <label>Footer Description</label>
                      <textarea name="footer_description" rows="5"  class="form-control textarea">{{ @$settings->footer_description }}</textarea>
                      <span style="color:red;">{{ $errors->first('footer_description') }}</span>
                    </div>
                    <div class="col-md-3">
