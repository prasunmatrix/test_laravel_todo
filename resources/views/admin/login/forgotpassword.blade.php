          ...
          <div class="row justify-content-center">
            <div class="col-lg-5">
              <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                  <form action="{{ route('admin.post-forget-password') }}" method="post" id="login_table">
                    @csrf
                    <div class="form-floating mb-3">
                      <input class="form-control" id="resetemail" type="email" name="resetemail" placeholder="name@example.com" required />
