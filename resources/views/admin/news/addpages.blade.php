      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.news.add-pages-post',$id) }}" enctype="multipart/form-data" id="pageAdd" autocomplete="off">
          ...
          <div class="mb-3">
            ...
            <span style="color:red;">{{ $errors->first('page_number') }}</span>
          </div>
          <div class="mb-3">
            <label>Page Preview</label>
            <input type="file" name="page_preview" id="page_preview" value="{{old('page_preview')}}" required class="form-control" />
