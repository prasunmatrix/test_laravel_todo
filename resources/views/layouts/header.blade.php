        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              @endphp
              <!-- <a class="nav-link"  href="javascript:void(0);" onclick="printPreview('{{-- $letestNewsPageData->id ?? '' --}}')">PDF</a> -->
              <!-- <a class="nav-link"  href="javascript:void(0);" onclick="pdfPreview('{{-- $letestNewsPageData->id ?? '' --}}')">PDF PREVIEW</a> -->
            </li>
          </ul>
        </div>
      </nav>
